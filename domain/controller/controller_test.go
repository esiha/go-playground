...
func TestController_Run_oneMower(t *testing.T) {
	m := mower.New(mower.NewPosition(point.New(0, 0), direction.North), []instruction.Instruction{})
...
func TestController_Run_remainsInLawn(t *testing.T) {
	m := mower.New(mower.NewPosition(point.New(4, 4), direction.North), []instruction.Instruction{})
	i := []instruction.Instruction{
